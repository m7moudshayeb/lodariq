...
const SEPARATE_STEP_ACTION_TYPES = new Set<LodariqBlock['type']>(['link']);

/** Replaces the freeform document body, including CTAs, while retaining legacy link actions and utilities. */
