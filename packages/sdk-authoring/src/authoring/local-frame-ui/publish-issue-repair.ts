...
const PUBLISH_ISSUE_REPAIR_INTENTS = {
  ...
  choreography_target_missing: behaviorIntent(authoringText('Review sequence'), 'button.action'),
  choreography_step_missing: editorIntent(authoringText('Open Flow Map')),
