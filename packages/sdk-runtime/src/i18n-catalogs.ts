...
const DE_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Durchsuchen Sie Erfahrungen – schließen Sie zuerst die aktuelle Erstellung",
  "Choose an experience type to start.": "Wählen Sie zum Starten einen Erlebnistyp.",
  "Close current authoring before opening another experience": "Schließen Sie die aktuelle Erstellung, bevor Sie ein anderes Erlebnis öffnen",
  "Connecting to Lodariq": "Verbindung mit Lodariq herstellen",
  "Connecting…": "Verbinden…",
  "Could not connect. Try again": "Es konnte keine Verbindung hergestellt werden. Versuchen Sie es erneut",
  "Experiences on this page": "Erfahrungen auf dieser Seite",
  "Guide people through a sequence of steps.": "Führen Sie Menschen durch eine Abfolge von Schritten.",
  ...
  "Lodariq tour presentation is unavailable": "Die Präsentation der Lodariq-Tour ist nicht verfügbar",
  ...
  "New experience — close current authoring first": "Neue Erfahrung – schließen Sie zuerst die aktuelle Dokumenterstellung",
  "No published experience is available to preview": "Es steht keine veröffentlichte Erfahrung zur Vorschau zur Verfügung",
...
const FR_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Parcourir les expériences – fermer d'abord la création actuelle",
  "Choose an experience type to start.": "Choisissez un type d'expérience pour commencer.",
  "Close current authoring before opening another experience": "Fermer la création actuelle avant d'ouvrir une autre expérience",
  ...
  "Lodariq tour presentation is unavailable": "La présentation de la tournée Lodariq n'est pas disponible",
  ...
  "New experience — close current authoring first": "Nouvelle expérience : fermez d'abord la création actuelle",
  "No published experience is available to preview": "Aucune expérience publiée n'est disponible en aperçu",
...
const ES_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Explorar experiencias: cerrar primero la creación actual",
  "Choose an experience type to start.": "Elija un tipo de experiencia para comenzar.",
  "Close current authoring before opening another experience": "Cerrar la creación actual antes de abrir otra experiencia",
  ...
  "Guide people through a sequence of steps.": "Guíe a las personas a través de una secuencia de pasos.",
  ...
  "Lodariq tour presentation is unavailable": "La presentación de la gira de Lodariq no está disponible.",
  ...
  "New experience — close current authoring first": "Nueva experiencia: cierre primero la creación actual",
  "No published experience is available to preview": "No hay ninguna experiencia publicada disponible para obtener una vista previa",
...
const PT_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Procure experiências – feche primeiro a autoria atual",
  "Choose an experience type to start.": "Escolha um tipo de experiência para começar.",
  "Close current authoring before opening another experience": "Feche a criação atual antes de abrir outra experiência",
  ...
  "Guide people through a sequence of steps.": "Guie as pessoas através de uma sequência de etapas.",
  ...
  "New experience — close current authoring first": "Nova experiência – feche primeiro a autoria atual",
  "No published experience is available to preview": "Nenhuma experiência publicada está disponível para visualização",
...
const AR_CATALOG: RuntimeCatalog = {
  ...
  "Close current authoring before opening another experience": "أغلق التأليف الحالي قبل فتح تجربة أخرى",
...
const TR_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Deneyimlere göz atın — önce mevcut yazmayı kapatın",
  "Choose an experience type to start.": "Başlamak için bir deneyim türü seçin.",
  "Close current authoring before opening another experience": "Başka bir deneyim açmadan önce mevcut yazmayı kapatın",
...
const IT_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Sfoglia le esperienze: chiudi prima la creazione corrente",
  "Choose an experience type to start.": "Scegli un tipo di esperienza per iniziare.",
  "Close current authoring before opening another experience": "Chiudi la creazione corrente prima di aprire un'altra esperienza",
  ...
  "Guide people through a sequence of steps.": "Guida le persone attraverso una sequenza di passaggi.",
  ...
  "Lodariq tour presentation is unavailable": "La presentazione del tour di Lodariq non è disponibile",
  "Lodariq tour presentation was canceled": "La presentazione del tour di Lodariq è stata annullata",
  "Minimize Lodariq authoring": "Riduci al minimo la creazione di Lodariq",
  "New experience": "Nuova esperienza",
  "New experience — close current authoring first": "Nuova esperienza: chiudi prima la creazione corrente",
  "No published experience is available to preview": "Nessuna esperienza pubblicata è disponibile per l'anteprima",
...
const NL_BE_CATALOG: RuntimeCatalog = {
  ...
  "Browse experiences — close current authoring first": "Blader door ervaringen - sluit eerst de huidige auteur",
  "Choose an experience type to start.": "Kies een ervaringstype om te beginnen.",
  "Close current authoring before opening another experience": "Sluit het huidige ontwerp voordat u een andere ervaring opent",
  ...
  "New experience — close current authoring first": "Nieuwe ervaring: sluit eerst de huidige auteur",
  "No published experience is available to preview": "Er is geen gepubliceerde ervaring beschikbaar om een voorbeeld van te bekijken",
