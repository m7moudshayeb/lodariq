...
| Staging SDK install flow                                     | Dashboard server action/token panel, staging-only install environment options, generated snippet tests and e2e fixture coverage           | Local code ready; deployed staging smoke pending                         |
| Creator authoring gate                                       | Authoring session routes, creator loader snippet, creator installer and toolbar tests                                                     | Local code ready; live deployed creator smoke pending                    |
