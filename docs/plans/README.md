...
| [Tour Authoring Reliability and Capabilities](tour-authoring-reliability-and-capabilities.md)          | Local capability milestone integrated; reliability closure and external validation pending | Transactional edits, context-aware targets, choreography, collision-free preview, reusable styles, accessibility, and complex flows |
